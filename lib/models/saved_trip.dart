...
class SavedTrip {
  ...
  static List<SavedTrip> savedTrips = [];
}

class SavedTripListScreen extends StatelessWidget {
  const SavedTripListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final trips = SavedTrip.savedTrips;

    return Scaffold(
      appBar: AppBar(title: const Text('내 저장된 일정')),
      body: trips.isEmpty
          ? const Center(child: Text('저장된 일정이 없습니다.'))
          : ListView.builder(
